...
import com.app.payloads.CouponRequestDTO;
...
public class OrderController {
	...
	public ResponseEntity<OrderDTO> orderProducts(@PathVariable String email, @PathVariable Long cartId, @PathVariable String paymentMethod, @RequestBody(required = false) CouponRequestDTO couponRequestDTO) {

		Long couponId = (couponRequestDTO != null) ? couponRequestDTO.getCouponId() : null;
